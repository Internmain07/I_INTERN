        ...
        <>
          ...
          >
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
                            ...
                            <div className="space-y-3">
                              {applicant.work_experiences.slice(0, 2).map((exp, idx) => (
                                <div key={exp.id}>
                                  ...
                                  {idx < applicant.work_experiences!.length - 1 && idx < 1 && (
                                    <div className="border-b my-2"></div>
                                  )}
                                </div>
                              ))}
                              {applicant.work_experiences.length > 2 && (
                                <p className="text-xs text-gray-500 italic">+{applicant.work_experiences.length - 2} more (view full details)</p>
                              )}
                            </div>
                          ) : (
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="space-y-2">
                            <p className="text-gray-900 font-medium">{applicant.education || 'Not specified'}</p>
                            {applicant.graduation_year && (
                              <p className="text-sm text-gray-600">Expected Graduation: {applicant.graduation_year}</p>
                            )}
                            {applicant.grading_type && applicant.grading_score && (
                              <p className="text-sm text-gray-600">{applicant.grading_type}: {applicant.grading_score}</p>
                            )}
                          </div>
                        </CardContent>
                      </Card>
              ...
              {showDetailedView && (
                <div id="detailed-applicant-info" className="border-t bg-gray-50">
                  <div className="sticky top-0 bg-gray-50 px-6 py-4 border-b flex items-center justify-between z-10">
                  ...
                  {(applicant.bio || applicant.linkedin || applicant.github || applicant.portfolio) && (
                    <div className="mb-6">
                      <h4 className="text-md font-medium mb-3 text-gray-800">Profile</h4>
                      <div className="bg-white p-4 rounded-lg border">
                        {applicant.bio && (
                          <div className="mb-4">
                            <label className="text-sm font-medium text-gray-500">About</label>
                            <p className="text-sm text-gray-700 mt-1">{applicant.bio}</p>
                          </div>
                        )}
                        
                        {(applicant.linkedin || applicant.github || applicant.portfolio) && (
                          <div>
                            <label className="text-sm font-medium text-gray-500 mb-2 block">Links</label>
                            <div className="flex flex-wrap gap-2">
                              {applicant.linkedin && (
                                <a
                              ...
                              {applicant.portfolio && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center px-3 py-1.5 text-sm bg-teal-50 hover:bg-teal-100 text-teal-700 rounded-md transition-colors"
                                >
                  ...
                  {/* Skills from Real Data */}
                  <div className="mb-6">
                    <h4 className="text-md font-medium mb-3 text-gray-800">Technical Skills</h4>
                    {applicant.skills && applicant.skills.length > 0 ? (
                      <div className="flex flex-wrap gap-2">
                        {applicant.skills.map((skill, index) => (
                          <Badge 
                            key={index}
                            variant="outline" 
                            className="border-teal-200 text-teal-700 bg-teal-50 px-3 py-1"
                          >
                      ...
                      <p className="text-sm text-gray-500 italic">No skills information available</p>
                    )}
                  </div>

                  {/* Work Experience from Real Data */}
                  <div className="mb-6">
                    <h4 className="text-md font-medium mb-3 text-gray-800">Work Experience</h4>
                    {applicant.work_experiences && applicant.work_experiences.length > 0 ? (
                  ...
                  <div className="mb-6">
                    <h4 className="text-md font-medium mb-3 text-gray-800">Projects</h4>
                  ...
                  {/* Academic Information from Real Data */}
                  <div className="mb-6">
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <p className="text-gray-900">{applicant.university || 'Not specified'}</p>
                          </div>
                          <div>
                            <label className="text-sm font-medium text-gray-500">Major</label>
                            <p className="text-gray-900">{applicant.major || 'Not specified'}</p>
                          </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                          ...
                          {applicant.grading_type && applicant.grading_score && (
                            <div>
                              ...
                              <p className="text-gray-900">{applicant.grading_score}</p>
                            </div>
                          )}
                        </div>
                      </div>
