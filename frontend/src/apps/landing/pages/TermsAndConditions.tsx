...
const TermsAndConditions: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F0F9F8] to-white">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#004F4D] to-[#1F7368] text-white py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-white/90">
              Enhanced Terms and Conditions for I-Intern Platform
            </p>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        >
          <h2 className="text-2xl font-bold text-[#004F4D] mb-4">Preamble and Legal Framework</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Welcome to <strong>i-intern.com</strong> (hereinafter referred to as the "Site," "Platform," or "I-Intern" 
            interchangeably), a comprehensive internship facilitation portal operated by <strong>I-Intern Technologies 
            Private Limited</strong> (hereinafter referred to as "ITPL," "Company," "we," "us," or "our"), a company 
        ...
        {sections.map((section, index) => (
          ...
          >
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 bg-[#F0F9F8] rounded-xl flex items-center justify-center text-[#1F7368]">
                {section.icon}
              </div>
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-[#004F4D]">{section.title}</h2>
              </div>
            </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#004F4D] to-[#1F7368] rounded-2xl shadow-lg p-8 text-white"
        >
          <h2 className="text-2xl font-bold mb-4">Effective Date and Acknowledgment</h2>
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center gap-2 bg-[#1F7368] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#004F4D] transition-colors shadow-lg"
          >
