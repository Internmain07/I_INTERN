...
import { 
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Connect with ambitious students from top institutions across India, bringing fresh perspectives and innovative ideas.'
    },
    {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Access thousands of pre-screened students actively looking for internship opportunities.'
    },
    {
      icon: <Award size={24} />,
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl mb-10 text-white/90 leading-relaxed">
              Connect with India's brightest students. Find skilled interns faster with AI-powered matching and verified candidate profiles.
            </p>
